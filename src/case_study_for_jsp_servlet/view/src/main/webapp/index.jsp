...
<div class="container-fluid ">
    <div class="row align-items-center justify-content-between">
        <div class="col-md-3">
            <img src="webapp/img/furama_logo.png" width="120px" height="120px">
        </div>
    ...
    <div class="row border bg-secondary">
        <ul class="col-md-7 nav justify-content-center">
            ...
            <li class="nav-item">
                <a class="nav-link text-black ">Service</a>
            </li>
            <li class="nav-item">
...
<script src="webapp/bootstrap-5.1.3-dist/js/bootstrap.js"></script>
</html>